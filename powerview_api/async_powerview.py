...
class PowerViewAsync(PowerViewBase):
    ...
    def __init__(self, ip_address, session, get_wrapper, put_wrapper):
...
def test(pv):
    ...
    yield from pv.activate_scene(60133)
...
if __name__ == "__main__":
    ...
    pv = PowerViewAsync("192.168.2.4", session, async_gett, async_putt)
